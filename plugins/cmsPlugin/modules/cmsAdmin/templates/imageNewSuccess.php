...
<div id="sf_admin_container" class="admin_container_cms">
  <h1 class="titulo">Pàgina "<a href="<?php echo url_for('cms_admin_page_edit',$page) ?>"><?php echo $page->titre ?></a>". Imatges</h1>
...
<form method="post" action="<?php echo url_for('cms_admin_image_create',$content) ?>" enctype="multipart/form-data">
