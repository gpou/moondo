...
<?php unset($this->config['new']['title']) ?>
  ...
  {
    return '<?php echo $this->escapeString(isset($this->config['list']['help']) ? $this->config['list']['help'] : '') ?>';
<?php unset($this->config['list']['help']) ?>
  }

  public function getEditHelp()
  {
    return '<?php echo $this->escapeString(isset($this->config['edit']['help']) ? $this->config['edit']['help'] : '') ?>';
<?php unset($this->config['edit']['help']) ?>
  }

  public function getNewHelp()
  {
    return '<?php echo $this->escapeString(isset($this->config['new']['help']) ? $this->config['new']['help'] : '') ?>';
<?php unset($this->config['new']['help']) ?>
  }
