...
<?php unset($this->config['list']['display'], $this->config['list']['hide']) ?>
  ...
  public function getListDisplayOn()
  {
<?php if (isset($this->config['list']['display_on'])): ?>
    return <?php echo $this->asPhp($this->config['list']['display_on']) ?>;
<?php else: ?>
    return <?php echo $this->asPhp($this->getAllFieldNames(false)) ?>;
<?php endif; ?>
<?php unset($this->config['list']['display_on']) ?>
  }
  
  public function getListColumnsGroups()
  {
<?php if (isset($this->config['list']['display_groups'])): ?>
    return <?php echo $this->asPhp($this->config['list']['display_groups']) ?>;
<?php else: ?>
    return <?php echo $this->asPhp(array('tot'=>$this->getListDisplayOn())) ?>;
<?php endif; ?>
<?php unset($this->config['list']['display_groups']) ?>
  }

  public function getListFiltersGroups()
  {
<?php if (isset($this->config['filter']['display_groups'])): ?>
    return <?php echo $this->asPhp($this->config['filter']['display_groups']) ?>;
<?php else: ?>
    return <?php echo $this->asPhp(array('tot'=>$this->config['filter']['display'])) ?>;
<?php endif; ?>
<?php unset($this->config['filter']['display_groups']) ?>
  }
