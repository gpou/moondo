 ...
 * @method PageContentLink setContentId()   Sets the current record's "content_id" value
 * @method PageContentLink setUrl()         Sets the current record's "url" value
 * @method PageContentLink setTitre()       Sets the current record's "titre" value
 * @method PageContentLink setPageContent() Sets the current record's "PageContent" value
 * 
 * @package    moondo
 * @subpackage model
 ...
 */
abstract class BasePageContentLink extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('page_content_link');
