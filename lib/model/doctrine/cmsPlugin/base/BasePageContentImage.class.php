 ...
 * @method PageContentImage setContentId()   Sets the current record's "content_id" value
 * @method PageContentImage setImageSmall()  Sets the current record's "image_small" value
 * @method PageContentImage setImage()       Sets the current record's "image" value
 * @method PageContentImage setTitre()       Sets the current record's "titre" value
 * @method PageContentImage setPageContent() Sets the current record's "PageContent" value
 * 
 * @package    moondo
 * @subpackage model
 ...
 */
abstract class BasePageContentImage extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('page_content_image');
