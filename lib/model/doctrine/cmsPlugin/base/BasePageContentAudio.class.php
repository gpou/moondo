 ...
 * @method PageContentAudio setContentId()   Sets the current record's "content_id" value
 * @method PageContentAudio setUrl()         Sets the current record's "url" value
 * @method PageContentAudio setTitre()       Sets the current record's "titre" value
 * @method PageContentAudio setPageContent() Sets the current record's "PageContent" value
 * 
 * @package    moondo
 * @subpackage model
 ...
 */
abstract class BasePageContentAudio extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('page_content_audio');
