...
CKEDITOR.dialog.add( 'link', function( editor )
{
	...
	{
		var dialog = this.getDialog(),
			partIds = [ 'urlOptions', 'anchorOptions', 'emailOptions', 'pageOptions' ],
	...
	var parseLink = function( editor, element )
	{
		...
		if ( !retval.type )
		{
			...
			else if ( ( pageMatch = href.match( pageRegex ) ) )
			{
				retval.type = 'page';
				retval.page = pageMatch[1];
			}
	...
	var linkPages = editor.config.linkPages || [];
					...
					},
					{
						...
						[
							...
							},
							{
								...
								id : 'noPages',
								style : 'text-align: center;',
								html : '<div role="label" tabIndex="-1">No pages</div>',
								focus : true,
								setup : function( data )
								{
									if ( linkPages.length < 1 )
		...
		onOk : function()
		{
			...
			switch ( data.type || 'url' )
			{
				...
				case 'email':
					...
					break;
				case 'page':
					attributes._cke_saved_href = '_'+data.page;
					break;
			}
